        ...
        <div className={`relative w-[500px] ${className}`}>
            <div
                ...
                className={`max-h-[400px] overflow-y-auto p-4 ${displayScrollbar
                        ? "[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#eee] [&::-webkit-scrollbar-thumb]:bg-[#ccc] [&::-webkit-scrollbar-thumb]:rounded-[4px]"
                        : "scrollbar-hide"
                    }`}
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        <div
                            className={`p-4 bg-white border border-gray-200 rounded-lg ${selectedIndex === index ? "bg-gray-200" : ""
                                } ${itemClassName}`}
                        >
